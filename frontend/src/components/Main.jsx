  ...
  return (
    <div className="w">
      <input
        ...
        className="mt-16 ml-10 w-44 sm:w-60 sm:ml-24 md:w-[300px] md:ml-40 lg:w-[450px] xl:w-[550px] xl:ml-72 p-4 rounded-l-full outline-none border-none text-xl pl-10 relative lg:ml-60"
        value={text}
